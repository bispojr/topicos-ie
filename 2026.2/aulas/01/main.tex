...
\date{\textbf{18 de agosto de 2026} }
...
\begin{document}
	...
	\begin{frame}{Informações Importantes}
		\begin{block}{Disciplina}
			\begin{itemize}
				\item Tópicos em Informática e Educação (ICE0648) \\
				Informática e Educação (PPGCC0005)
				\item 15h30-17h10 (Terça, [LSD])\\
				 15h30-17h10 (Quinta, [LSD])
				\item Dúvidas: Logo após a aula\color{red}{*}
				%\item Google Clasroom: Código - {\color{blue} \bf sufpjv5}
				\item Repositório: \url{https://github.com/bispojr/topicos-ie/}
			\end{itemize}
		\end{block}
	\end{frame}	
	...
	\end{frame}
		...
		\begin{frame}{Rotina Acadêmica}
			...
			\begin{block}{Questões Conceituais IpC (QC)}
				Toda aula, com IpC,haverá questões conceituais abordadas em sala.
			\end{block}
		\end{frame}
